...
namespace SocialMedia.Api.Data.Migrations
{
    ...
    [Migration("20240613181603_UpdateAccountReactAndCommentPolicyToPolicyTable")]
    partial class UpdateAccountReactAndCommentPolicyToPolicyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.Authentication.SiteUser", b =>
                {
                    ...
                    b.Property<string>("AccountPolicyId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("CommentPolicyId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("FriendListPolicyId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("PostsPolicyId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ReactPolicyId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("FriendListPolicyId1");
                    ...
                    b.HasIndex("PostsPolicyId");

                    b.HasIndex("ReactPolicyId");

                    b.HasIndex("ReactPolicyId1");
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.PostsPolicy", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.SarehneMessage", b =>
                {
                    ...
                    b.Property<DateTime>("SentAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 21, 16, 2, 753, DateTimeKind.Local).AddTicks(8667));
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.Authentication.SiteUser", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Data.Models.AccountPolicy", null)
                        .WithMany("Users")
                        .HasForeignKey("AccountPolicyId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SocialMedia.Data.Models.CommentPolicy", null)
                        .WithMany("Users")
                        .HasForeignKey("CommentPolicyId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SocialMedia.Data.Models.FriendListPolicy", null)
                        .WithMany("Users")
                        .HasForeignKey("FriendListPolicyId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMedia.Data.Models.PostsPolicy", null)
                        .WithMany("Users")
                        .HasForeignKey("PostsPolicyId");
                    ...
                    b.HasOne("SocialMedia.Data.Models.ReactPolicy", null)
                        .WithMany("Users")
                        .HasForeignKey("ReactPolicyId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
