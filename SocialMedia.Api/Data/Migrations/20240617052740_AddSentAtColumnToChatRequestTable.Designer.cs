...
namespace SocialMedia.Api.Data.Migrations
{
    ...
    [Migration("20240617052740_AddSentAtColumnToChatRequestTable")]
    partial class AddSentAtColumnToChatRequestTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.SarehneMessage", b =>
                {
                    ...
                    b.Property<DateTime>("SentAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 17, 8, 27, 37, 807, DateTimeKind.Local).AddTicks(8954));
