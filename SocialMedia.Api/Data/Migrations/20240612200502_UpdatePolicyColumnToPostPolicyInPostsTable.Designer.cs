...
namespace SocialMedia.Api.Data.Migrations
{
    ...
    [Migration("20240612200502_UpdatePolicyColumnToPostPolicyInPostsTable")]
    partial class UpdatePolicyColumnToPostPolicyInPostsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.SarehneMessage", b =>
                {
                    ...
                    b.Property<DateTime>("SentAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 23, 4, 58, 175, DateTimeKind.Local).AddTicks(3105));
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.Post", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Data.Models.Policy", null)
                        .WithMany("Posts")
                        .HasForeignKey("PolicyId");
