...
namespace SocialMedia.Api.Data.Migrations
{
    ...
    [Migration("20240617103817_MakeChatRequestSentAtRequired")]
    partial class MakeChatRequestSentAtRequired
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.SarehneMessage", b =>
                {
                    ...
                    b.Property<DateTime>("SentAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 17, 13, 38, 14, 640, DateTimeKind.Local).AddTicks(4607));
