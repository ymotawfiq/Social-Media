...
namespace SocialMedia.Data.Migrations
{
    ...
    [Migration("20240613171309_UpdatePostReactAndCommentPolicyToPolicyTable")]
    partial class UpdatePostReactAndCommentPolicyToPolicyTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.SarehneMessage", b =>
                {
                    ...
                    b.Property<DateTime>("SentAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 20, 13, 8, 60, DateTimeKind.Local).AddTicks(9182));
            ...
            modelBuilder.Entity("SocialMedia.Data.Models.Authentication.SiteUser", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Data.Models.PostsPolicy", "PostPolicy")
                        .WithMany("Users")
